...
import { Settings, Mail, Github, Linkedin, Play, Award, Users, Target } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-center gap-6 mt-12">
            {[
              ...
              { icon: Github, label: 'GitHub', color: 'from-purple-500 to-pink-500', href: '#' },
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="flex gap-3 max-w-md mx-auto">
              ...
              />
              <motion.button
                className="px-6 py-3 bg-gradient-to-r from-purple-600 to-orange-600 rounded-lg font-semibold"
